...
/**
 * This class represent a cell of our grid, which contain a number between 1 to 9 or nothing, on the window, 
 * link the view and the Model package,
 * We cannot change the value on this one.
 * 
 * @author BryanBoni
 */
